...
urlpatterns = [
    ...
    url(r'^wedding/w_1$', views.w_1, name='w_1'),
    url(r'^wedding/w_2$', views.w_2, name='w_2'),
    url(r'^wedding/w_3$', views.w_3, name='w_3'),
    url(r'^wedding/w_4$', views.w_4, name='w_4'),
    url(r'^wedding/w_5$', views.w_5, name='w_5'),
    url(r'^wedding/w_6$', views.w_6, name='w_6'),
